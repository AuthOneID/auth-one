...
function Sidebar({
  ...
  return (
    <div
      className="group peer text-sidebar-foreground hidden md:block shadow-[50px_0px_6px_42px_rgba(249,_115,_22,_0.5)]"
      data-state={state}
...
function SidebarInset({ className, ...props }: React.ComponentProps<'main'>) {
  return (
    <main
      ...
      className={cn(
        'relative flex w-full overflow-x-hidden flex-1 flex-col bg-gray-100',
